...
from video_management_app.tasks import convert_480p, convert_720p, convert_1080p, generate_thumbnail
...
def video_post_save(sender, instance, created, **kwargs):
    ...
    if not instance.thumbnail_url:
        queue.enqueue(generate_thumbnail,
                      instance.video_file.path, instance.id)
...
def video_post_delete(sender, instance, **kwargs):
    ...
    if instance.video_file:
        if os.path.isfile(instance.video_file.path):
            ...
            print("Video file deleted from filesystem")
